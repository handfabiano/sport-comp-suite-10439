...
DROP POLICY IF EXISTS "Organizadores podem gerenciar roles" ON public.user_roles;
...
DROP POLICY IF EXISTS "Organizadores podem criar e deletar equipes" ON public.equipes;
...
CREATE POLICY "Organizadores podem criar equipes"
...
DROP POLICY IF EXISTS "Responsáveis podem criar tokens" ON public.athlete_invite_tokens;
...
DROP POLICY IF EXISTS "Responsáveis podem ver tokens de sua equipe" ON public.athlete_invite_tokens;
